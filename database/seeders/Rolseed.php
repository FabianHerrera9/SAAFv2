...
class Rolseed extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name'=>'asignaciones.index'])->syncRoles([$rol1,$rol3]);
        Permission::create(['name'=>'asignaciones.crear'])->syncRoles([$rol1,$rol3]);
        Permission::create(['name'=>'asignaciones.guardar'])->syncRoles([$rol1,$rol3]);
        Permission::create(['name'=>'asignaciones.editar'])->syncRoles([$rol1,$rol3]);
        Permission::create(['name'=>'asignaciones.actualizar'])->syncRoles([$rol1,$rol3]);
        //permisos Mttogarant
